...
public class ModSounds {
    public static final Identifier ENTITY_GLAZE_AMBIENT_ID = Identifier.of(MOD_ID, "entity.glaze.ambient");
    public static SoundEvent ENTITY_GLAZE_AMBIENT_EVENT = SoundEvent.of(ENTITY_GLAZE_AMBIENT_ID);
    public static final Identifier ENTITY_GLAZE_HURT_ID = Identifier.of(MOD_ID, "entity.glaze.hurt");
    public static SoundEvent ENTITY_GLAZE_HURT_EVENT = SoundEvent.of(ENTITY_GLAZE_HURT_ID);
    public static final Identifier ENTITY_GLAZE_DEATH_ID = Identifier.of(MOD_ID, "entity.glaze.death");
    public static SoundEvent ENTITY_GLAZE_DEATH_EVENT = SoundEvent.of(ENTITY_GLAZE_DEATH_ID);
    public static final Identifier ENTITY_GLAZE_FREEZE_ID = Identifier.of(MOD_ID, "entity.glaze.freeze");
    public static SoundEvent ENTITY_GLAZE_FREEZE_EVENT = SoundEvent.of(ENTITY_GLAZE_FREEZE_ID);
    public static final Identifier VILLAGER_INNKEEPER_ID = Identifier.of(MOD_ID, "villager.innkeeper");
    public static SoundEvent VILLAGER_INNKEEPER_EVENT = SoundEvent.of(VILLAGER_INNKEEPER_ID);
    public static final Identifier FROSTMONARCH_SCREECH_ID = Identifier.of(MOD_ID, "frostmonarch.screech");
