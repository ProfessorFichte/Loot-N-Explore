...
import more_rpg_loot.item.weapons.ElderGuardianMeeleWeapon;
...
public class WeaponRegister {
    ...
    public static Item ELDER_GUARDIAN_SWORD = new ElderGuardianMeeleWeapon(ToolMaterials.NETHERITE,4,swordVanillaAttackSpeed, new FabricItemSettings());
    public static Item ELDER_GUARDIAN_AXE = new ElderGuardianMeeleWeapon(ToolMaterials.NETHERITE,5,axeVanillaAttackSpeed, new FabricItemSettings());
    public static Item ENDER_DRAGON_SWORD = new DragonMeeleeWeapon(ToolMaterials.NETHERITE,4,swordVanillaAttackSpeed, new FabricItemSettings());
    public static Item ENDER_DRAGON_AXE = new DragonMeeleeWeapon(ToolMaterials.NETHERITE,5,axeVanillaAttackSpeed, new FabricItemSettings());
    public static Item WITHER_SWORD = new WitherMeleeWeapon(ToolMaterials.NETHERITE,4,swordVanillaAttackSpeed, new FabricItemSettings());
    public static Item WITHER_AXE = new WitherMeleeWeapon(ToolMaterials.NETHERITE,5,axeVanillaAttackSpeed, new FabricItemSettings());
