...
public class GlacialAxe extends AxeItem implements ConfigurableAttributes {
    ...
    public GlacialAxe(ToolMaterial toolMaterial, float attackDamage, float attackSpeed, Settings settings) {
