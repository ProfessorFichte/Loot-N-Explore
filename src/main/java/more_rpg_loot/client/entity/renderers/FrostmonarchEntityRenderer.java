...
public class FrostmonarchEntityRenderer extends SkeletonEntityRenderer {
    private static final Identifier TEXTURE = Identifier.of(MOD_ID, "textures/entity/mobs/frostmonarch.png");
    private static final Identifier EYES = Identifier.of(MOD_ID, "textures/entity/mobs/frostmonarch_eyes.png");
    private static final Identifier OVERLAY = Identifier.of(MOD_ID, "textures/entity/mobs/frostmonarch_overlay.png");
