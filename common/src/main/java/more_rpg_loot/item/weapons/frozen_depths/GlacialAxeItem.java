...
public class GlacialAxeItem extends AxeItem {
    private static final int COOLDOWN = 360;
    public GlacialAxeItem(float bonus, float speed) { super(ToolMaterials.NETHERITE, LNE_WeaponItems.meleeSettings(bonus, speed)); }
