...
public class MonarchsGuardHeldItemFeatureRenderer extends FeatureRenderer<MonarchsGuardEntity, MonarchsGuardModel> {
    ...
    @Override
    public void render(MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, MonarchsGuardEntity entity, float limbAngle, float limbDistance, float tickDelta, float animationProgress, float headYaw, float headPitch) {
